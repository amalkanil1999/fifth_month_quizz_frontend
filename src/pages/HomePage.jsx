...
import { quizConfig } from "../axiosConfig.jsx";
    ...
    <>
      ...
      <MainContainer>
        <QuestionContainer>
                    ...
                    <form onSubmit={handleSubmit}>
                      <RadioGroup>
                        <RadioButton
                          style={{
                            backgroundColor:
                              selectedOption === e.choice_1 && "#25d4dc",
                          }}
                          onClick={() => {
                        ...
                        <RadioButton
                          ...
                          style={{
                            backgroundColor:
                              selectedOption === e.choice_2 && "#25d4dc",
                          }}
                        >
                          {e.choice_2}
                          <Round></Round>
                        ...
                        <RadioButton
                          ...
                          style={{
                            backgroundColor:
                              selectedOption === e.choice_3 && "#25d4dc",
                          }}
                        >
                          {e.choice_3}
                          <Round></Round>
                        ...
                        <RadioButton
                          ...
                          style={{
                            backgroundColor:
                              selectedOption === e.choice_4 && "#25d4dc",
                          }}
                        >
                          {e.choice_4}
                          <Round></Round>
          ...
          {data?.length === count && (
            <ResetBtn onClick={() => setMark(0)}>Reset Score</ResetBtn>
          )}
          {console.log(data)}
        </QuestionContainer>
        <TopScorer>
          <ScoreHeading>{firstName && <div>{firstName}</div>}</ScoreHeading>
